...
'               and total due
' Programmer:   Samuel Crumpler on 3/22/2016
...
Public Class frmMain
    ...
    Dim intTotalVehicles As Integer
    ...
    Private Sub CancelKeys(sender As Object, e As KeyPressEventArgs
                       ...
                       txtAdults.KeyPress, txtChildren.KeyPress, txtVehicles.KeyPress
    ...
    Private Sub ClearLabels(sender As Object, e As EventArgs) _
        ...
        txtAdults.TextChanged, txtChildren.TextChanged, txtVehicles.TextChanged
    ...
    Private Sub btnCalc_Click(sender As Object, e As EventArgs) Handles btnCalc.Click
        ...
        Const intPARKING_FEE As Integer = 5
        ...
        Dim intTotalParkingFee As Integer
        ...
        Integer.TryParse(txtVehicles.Text, intTotalVehicles)
        ...
        Else
            ' calculate charges
            intTotalParkingFee = intNights * intTotalVehicles * intPARKING_FEE
            ...
            dblTotalDue = intTotalRoomChg +
                dblTax + intTotalResortFee + intTotalParkingFee

            ' display charges
            lblRoomChg.Text = intTotalRoomChg.ToString("N2")
            lblTax.Text = dblTax.ToString("N2")
            lblResortFee.Text = intTotalResortFee.ToString("N2")
            lblParkingFee.Text = intTotalParkingFee.ToString("N2")
            lblTotalDue.Text = dblTotalDue.ToString("C2")
        End If
    End Sub

    Private Sub chkVehicles_CheckedChanged(sender As Object, e As EventArgs) Handles chkVehicles.CheckedChanged
        If CInt(Int32.TryParse(txtVehicles.Text, intTotalVehicles)) = 0 Then
            'Add the number "1", and change color.
            txtVehicles.Text = "1"
            txtVehicles.BackColor = SystemColors.Window
        Else
            'Revert to empty string, and change color.
            txtVehicles.Text = ""
            txtVehicles.BackColor = SystemColors.Control
        End If
    End Sub
End Class
